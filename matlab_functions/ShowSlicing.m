...
[Atoms, Slice] = getSliceSpecimen(input_multislice.spec_atoms, input_multislice.spec_lx, input_multislice.spec_ly, input_multislice.spec_dz, inFP, input_multislice.DimFP, input_multislice.SeedFP);
...
Planes = getPlanes(input_multislice.spec_atoms, input_multislice.spec_lx, input_multislice.spec_ly, inFP, input_multislice.DimFP, input_multislice.SeedFP);
[nPlanes, ~] = size(Planes);
for i = 1:nPlanes
    hold on;
