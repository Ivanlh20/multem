classdef parameters
   ...
   properties
      ...
      reverse_multislice(1,1) uint64 {mustBeLessThanOrEqual(reverse_multislice,1),mustBeNonnegative} = 1; 		% 1: true, 0:false
      ...
      potential_slicing(1,1) uint64 {mustBeLessThanOrEqual(potential_slicing,3),mustBePositive} = 1;          % ePS_Planes = 1, ePS_dz_Proj = 2, ePS_dz_Sub = 3, ePS_Auto = 4
      ...
      cond_lens_si_rad_npts(1,1) uint64 = 8;                % # of integration points. It will be only used if illumination_model=4
      ...
      scanning_type(1,1) uint64 {mustBeLessThanOrEqual(scanning_type,2),mustBePositive} = 1; 					% eST_Line = 1, eST_Area = 2
      ...
      scanning_square_pxs(1,1) uint64 {mustBeLessThanOrEqual(scanning_square_pxs,1),mustBeNonnegative} = 0; 				% 0: false, 1: true
