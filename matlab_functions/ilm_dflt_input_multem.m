function [input_multem] = ilm_dflt_input_multem()
    ...
    input_multem.spec_lx = 10;                                  % simulation box length in x direction (�)
    input_multem.spec_ly = 10;                                  % simulation box length in y direction (�)
    input_multem.spec_lz = 10;                                  % simulation box length gpuDEin z direction (�)
    ...
    input_multem.scanning_x0 = 0.0;                 			% x-starting point (�)
    input_multem.scanning_y0 = 0.0;                 			% y-starting point (�)
    input_multem.scanning_xe = 4.078;               			% x-final point (�)
    input_multem.scanning_ye = 4.078;               			% y-final point (�)
