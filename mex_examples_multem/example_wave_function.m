...
input_multislice.output_area_ix_0 = 1;                             % x-starting pixel
input_multislice.output_area_iy_0 = 1;                             % y-starting pixel
input_multislice.output_area_ix_e = 1;                             % x-final pixel
input_multislice.output_area_iy_e = 1;                             % y-final pixel
