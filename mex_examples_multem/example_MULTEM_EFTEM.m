...
input_multislice.simulation_type = 62;
...
input_multislice.obj_lens_dsf_npoints = 10;                 % # integration steps for the defocus Spread. It will be only used if illumination_model=4
