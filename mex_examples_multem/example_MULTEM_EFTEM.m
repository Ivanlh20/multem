...
input_multislice.illumination_model = 1;             % 1: coherente mode
...
input_multislice.obj_lens_Cs3 = 0;                % Third order spherical aberration (mm)
...
%     clear il_MULTEM;
%     tic;
%     [m2psi_tot] = il_MULTEM(input_multislice); 
%     toc;
%     figure(1);
%     subplot(2, 1, 1);
%     hold on;
