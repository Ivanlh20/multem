...
input_multislice.cond_lens_c_10 = -88.741;            % Defocus (�)
input_multislice.cond_lens_c_30 = 0.04;            % Third order spherical aberration (mm)
input_multislice.cond_lens_c_50 = 10;             % Fifth order spherical aberration (mm)
...
input_multislice.scanning_ye = (ly+scan_field)/2;
...
input_multislice.detector.cir(1).outer_ang = 190; % Outer angle(mrad)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Check %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tfm_check_stem_setup(input_multislice, 1)
