...
na = 6; nb = 6; nc = 10; ncu = 4; rms3d = 0.15;
...
if(lay_pos==1)
    input_multislice.spec_amorp(1).z_0 = z_min-lz;          % Starting z position of the amorphous layer (Å)
    input_multislice.spec_amorp(1).z_e = z_min;             % Ending z position of the amorphous layer (Å)
else
    input_multislice.spec_amorp(1).z_0 = z_max;             % Starting z position of the amorphous layer (Å)
    input_multislice.spec_amorp(1).z_e = z_max+lz;          % Ending z position of the amorphous layer (Å)
end
...
% 
% if(lay_pos==1)
%     input_multislice.spec_amorp(2).z_0 = z_min-lz;          % Starting z position of the amorphous layer (Å)
%     input_multislice.spec_amorp(2).z_e = z_min;             % Ending z position of the amorphous layer (Å)
% else
%     input_multislice.spec_amorp(2).z_0 = z_max;             % Starting z position of the amorphous layer (Å)
%     input_multislice.spec_amorp(2).z_e = z_max+lz;          % Ending z position of the amorphous layer (Å)
% end
% input_multislice.spec_amorp(2).dz = 2.0;                    % slice thick of the amorphous layer (Å)
...
for i = 1:nslice
    hold on;
    plot([-2 input_multislice.spec_lx], [Slice(i, 1) Slice(i, 1)], '-r', [-2 input_multislice.spec_lx], [Slice(i, 2) Slice(i, 2)], '-r');    
    axis equal;
...
for i = 1:nplanes
    hold on;
    plot([-2 input_multislice.spec_lx], [z_planes(i) z_planes(i)], '-b');    
    axis equal;
end
diff(z_planes)
