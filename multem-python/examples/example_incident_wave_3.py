...
def run():
    ...
    df0 = -15.836
    ax = numpy.arange(0, input_multem.spec_lx) / numpy.arange(
        input_multem.nx, input_multem.spec_lx
    )
    ay = numpy.arange(0, input_multem.spec_ly) / numpy.arange(
        input_multem.ny, input_multem.spec_ly
    )
