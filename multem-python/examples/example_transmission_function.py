...
def run():
    ...
    for i in range(nslice):
        ...
        ouput_multislice_1 = input_multem.multem.transmission_function
        ...
        st = time.perf_counter()
        #     #clear multem.transmission_function
        ouput_multislice_2 = input_multem.multem.transmission_function
        print("Time: %.4f seconds" % (time.perf_counter() - st))
        sum(
            abs(ouput_multislice_1.trans[:] - ouput_multislice_2.trans[:])
