...
namespace pybind11 { namespace detail {
  ...
  struct Helpers <mt::Input_Multislice<T>> {
    ...
    static
    mt::eIncident_Wave_Type get_iw_type(const mt::Input_Multislice<T>& self) {
      return self.iw_type;
    }
    
    static
    void set_iw_type(mt::Input_Multislice<T>& self, mt::eIncident_Wave_Type iw_type) {
      self.set_incident_wave_type(iw_type);
    }
    
    static
    T get_theta(const mt::Input_Multislice<T>& self) {
      return self.theta / mt::c_deg_2_rad;
    }
    
    static
    void set_theta(mt::Input_Multislice<T>& self, T theta) {
      self.theta = theta * mt::c_deg_2_rad;
    }
    
    static
    T get_phi(const mt::Input_Multislice<T>& self) {
      return self.phi / mt::c_deg_2_rad;
    }
    
    static
    void set_phi(mt::Input_Multislice<T>& self, T phi) {
      self.phi = phi * mt::c_deg_2_rad;
    }
    
    static
    T get_spec_rot_theta(const mt::Input_Multislice<T>& self) {
      return self.spec_rot_theta / mt::c_deg_2_rad;
    }
    
    static
    void set_spec_rot_theta(mt::Input_Multislice<T>& self, T spec_rot_theta) {
      self.spec_rot_theta = spec_rot_theta * mt::c_deg_2_rad;
    }
    
    static
    mt::r3d<T> get_spec_rot_u0(const mt::Input_Multislice<T>& self) {
      return self.spec_rot_u0;
    }
    
    static
    void set_spec_rot_u0(mt::Input_Multislice<T>& self, mt::r3d<T> spec_rot_u0) {
      spec_rot_u0.normalized();
      self.spec_rot_u0 = spec_rot_u0;
    }

    static
    std::vector<mt::Atom<T>> get_spec_atoms(const mt::Input_Multislice<T>& self) {
      return Helpers<mt::Atom_Data<T>>::get_spec_atoms(self.atoms);
    }
    
    static
    void set_spec_atoms(mt::Input_Multislice<T>& self, const std::vector<mt::Atom<T>>& spec_atoms) {
      Helpers<mt::Atom_Data<T>>::set_spec_atoms(self.atoms, spec_atoms);
    }

    static
    T get_spec_dz(const mt::Input_Multislice<T>& self) {
      return self.atoms.dz;
    }

    static
    void set_spec_dz(mt::Input_Multislice<T>& self, T spec_dz) {
      self.atoms.dz = spec_dz;
      self.grid_2d.dz = spec_dz;
    }

    static
    T get_spec_lx(const mt::Input_Multislice<T>& self) {
      return self.atoms.l_x;
    }

    static
    void set_spec_lx(mt::Input_Multislice<T>& self, T spec_lx) {
      self.atoms.l_x = spec_lx;
      self.grid_2d.lx = spec_lx;
    }

    static
    T get_spec_ly(const mt::Input_Multislice<T>& self) {
      return self.atoms.l_y;
    }

    static
    void set_spec_ly(mt::Input_Multislice<T>& self, T spec_ly) {
      self.atoms.l_y = spec_ly;
      self.grid_2d.ly = spec_ly;
    }

    static
    T get_spec_lz(const mt::Input_Multislice<T>& self) {
      return self.atoms.l_z;
    }

    static
    void set_spec_lz(mt::Input_Multislice<T>& self, T spec_lz) {
      self.atoms.l_z = spec_lz;
    }

    static
    int get_spec_cryst_na(const mt::Input_Multislice<T>& self) {
      return self.atoms.ct_na;
    }

    static
    void set_spec_cryst_na(mt::Input_Multislice<T>& self, int spec_cryst_na) {
      self.atoms.ct_na = std::max(1, spec_cryst_na);
    }

    static
    int get_spec_cryst_nb(const mt::Input_Multislice<T>& self) {
      return self.atoms.ct_nb;
    }

    static
    void set_spec_cryst_nb(mt::Input_Multislice<T>& self, int spec_cryst_nb) {
      self.atoms.ct_nb = std::max(1, spec_cryst_nb);
    }

    static
    int get_spec_cryst_nc(const mt::Input_Multislice<T>& self) {
      return self.atoms.ct_nc;
    }

    static
    void set_spec_cryst_nc(mt::Input_Multislice<T>& self, int spec_cryst_nc) {
      self.atoms.ct_nc = std::max(1, spec_cryst_nc);
    }

    static
    T get_spec_cryst_a(const mt::Input_Multislice<T>& self) {
      return self.atoms.ct_a;
    }

    static
    void set_spec_cryst_a(mt::Input_Multislice<T>& self, T spec_cryst_a) {
      self.atoms.ct_a = std::max(T(0), spec_cryst_a);
    }

    static
    T get_spec_cryst_b(const mt::Input_Multislice<T>& self) {
      return self.atoms.ct_b;
    }

    static
    void set_spec_cryst_b(mt::Input_Multislice<T>& self, T spec_cryst_b) {
      self.atoms.ct_b = std::max(T(0), spec_cryst_b);
    }

    static
    T get_spec_cryst_c(const mt::Input_Multislice<T>& self) {
      return self.atoms.ct_c;
    }

    static
    void set_spec_cryst_c(mt::Input_Multislice<T>& self, T spec_cryst_c) {
      self.atoms.ct_c = std::max(T(0), spec_cryst_c);
    }

    static
    T get_spec_cryst_x0(const mt::Input_Multislice<T>& self) {
      return self.atoms.ct_x0;
    }

    static
    void set_spec_cryst_x0(mt::Input_Multislice<T>& self, T spec_cryst_x0) {
      self.atoms.ct_x0 = std::max(T(0), spec_cryst_x0);
    }

    static
    T get_spec_cryst_y0(const mt::Input_Multislice<T>& self) {
      return self.atoms.ct_y0;
    }

    static
    void set_spec_cryst_y0(mt::Input_Multislice<T>& self, T spec_cryst_y0) {
      self.atoms.ct_y0 = std::max(T(0), spec_cryst_y0);
    }

    static
    std::vector<mt::Amorp_Lay_Info<T>> get_spec_amorp(const mt::Input_Multislice<T>& self) {
      return self.atoms.amorp_lay_info;
    }

    static
    void set_spec_amorp(mt::Input_Multislice<T>& self, const std::vector<mt::Amorp_Lay_Info<T>>& spec_amorp) {
      self.atoms.amorp_lay_info = spec_amorp;
    }

    static
    int get_nx(const mt::Input_Multislice<T>& self) {
      return self.grid_2d.nx;
    }

    static
    void set_nx(mt::Input_Multislice<T>& self, int nx) {
      self.grid_2d.nx = nx;
    }

    static
    int get_ny(const mt::Input_Multislice<T>& self) {
      return self.grid_2d.ny;
    }

    static
    void set_ny(mt::Input_Multislice<T>& self, int ny) {
      self.grid_2d.ny = ny;
    }

    static
    bool get_bwl(const mt::Input_Multislice<T>& self) {
      return self.grid_2d.bwl;
    }

    static
    void set_bwl(mt::Input_Multislice<T>& self, bool bwl) {
      self.grid_2d.bwl = bwl;
    }

    static
    int get_cond_lens_m(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.m;
    }

    static
    void set_cond_lens_m(mt::Input_Multislice<T>& self, int m) {
      self.cond_lens.m = m;
    }

    static
    T get_cond_lens_c_10(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.c_10;
    }

    static
    void set_cond_lens_c_10(mt::Input_Multislice<T>& self, T c_10) {
      self.cond_lens.c_10 = c_10;
    }

    static
    T get_cond_lens_c_12(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.c_12;
    }

    static
    void set_cond_lens_c_12(mt::Input_Multislice<T>& self, T c_12) {
      self.cond_lens.c_12 = c_12;
    }

    static
    T get_cond_lens_phi_12(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.phi_12 / mt::c_deg_2_rad;
    }

    static
    void set_cond_lens_phi_12(mt::Input_Multislice<T>& self, T phi_12) {
      self.cond_lens.phi_12 = phi_12 * mt::c_deg_2_rad;
    }

    static
    T get_cond_lens_c_21(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.c_21;
    }

    static
    void set_cond_lens_c_21(mt::Input_Multislice<T>& self, T c_21) {
      self.cond_lens.c_21 = c_21;
    }

    static
    T get_cond_lens_phi_21(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.phi_21 / mt::c_deg_2_rad;
    }

    static
    void set_cond_lens_phi_21(mt::Input_Multislice<T>& self, T phi_21) {
      self.cond_lens.phi_21 = phi_21 * mt::c_deg_2_rad;
    }

    static
    T get_cond_lens_c_23(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.c_23;
    }

    static
    void set_cond_lens_c_23(mt::Input_Multislice<T>& self, T c_23) {
      self.cond_lens.c_23 = c_23;
    }

    static
    T get_cond_lens_phi_23(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.phi_23 / mt::c_deg_2_rad;
    }

    static
    void set_cond_lens_phi_23(mt::Input_Multislice<T>& self, T phi_23) {
      self.cond_lens.phi_23 = phi_23 * mt::c_deg_2_rad;
    }

    static
    T get_cond_lens_c_30(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.c_30 / mt::c_mm_2_Angs;
    }

    static
    void set_cond_lens_c_30(mt::Input_Multislice<T>& self, T c_30) {
      self.cond_lens.c_30 = c_30 * mt::c_mm_2_Angs;
    }

    static
    T get_cond_lens_c_32(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.c_32;
    }

    static
    void set_cond_lens_c_32(mt::Input_Multislice<T>& self, T c_32) {
      self.cond_lens.c_32 = c_32;
    }

    static
    T get_cond_lens_phi_32(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.phi_32 / mt::c_deg_2_rad;
    }

    static
    void set_cond_lens_phi_32(mt::Input_Multislice<T>& self, T phi_32) {
      self.cond_lens.phi_32 = phi_32 * mt::c_deg_2_rad;
    }

    static
    T get_cond_lens_c_34(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.c_34;
    }

    static
    void set_cond_lens_c_34(mt::Input_Multislice<T>& self, T c_34) {
      self.cond_lens.c_34 = c_34;
    }

    static
    T get_cond_lens_phi_34(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.phi_34 / mt::c_deg_2_rad;
    }

    static
    void set_cond_lens_phi_34(mt::Input_Multislice<T>& self, T phi_34) {
      self.cond_lens.phi_34 = phi_34 * mt::c_deg_2_rad;
    }

    static
    T get_cond_lens_c_41(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.c_41;
    }

    static
    void set_cond_lens_c_41(mt::Input_Multislice<T>& self, T c_41) {
      self.cond_lens.c_41 = c_41;
    }

    static
    T get_cond_lens_phi_41(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.phi_41 / mt::c_deg_2_rad;
    }

    static
    void set_cond_lens_phi_41(mt::Input_Multislice<T>& self, T phi_41) {
      self.cond_lens.phi_41 = phi_41 * mt::c_deg_2_rad;
    }

    static
    T get_cond_lens_c_43(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.c_43;
    }

    static
    void set_cond_lens_c_43(mt::Input_Multislice<T>& self, T c_43) {
      self.cond_lens.c_43 = c_43;
    }

    static
    T get_cond_lens_phi_43(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.phi_43 / mt::c_deg_2_rad;
    }

    static
    void set_cond_lens_phi_43(mt::Input_Multislice<T>& self, T phi_43) {
      self.cond_lens.phi_43 = phi_43 * mt::c_deg_2_rad;
    }

    static
    T get_cond_lens_c_45(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.c_45;
    }

    static
    void set_cond_lens_c_45(mt::Input_Multislice<T>& self, T c_45) {
      self.cond_lens.c_45 = c_45;
    }

    static
    T get_cond_lens_phi_45(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.phi_45 / mt::c_deg_2_rad;
    }

    static
    void set_cond_lens_phi_45(mt::Input_Multislice<T>& self, T phi_45) {
      self.cond_lens.phi_45 = phi_45 * mt::c_deg_2_rad;
    }

    static
    T get_cond_lens_c_50(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.c_50 / mt::c_mm_2_Angs;
    }

    static
    void set_cond_lens_c_50(mt::Input_Multislice<T>& self, T c_50) {
      self.cond_lens.c_50 = c_50 * mt::c_mm_2_Angs;
    }

    static
    T get_cond_lens_c_52(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.c_52;
    }

    static
    void set_cond_lens_c_52(mt::Input_Multislice<T>& self, T c_52) {
      self.cond_lens.c_52 = c_52;
    }

    static
    T get_cond_lens_phi_52(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.phi_52 / mt::c_deg_2_rad;
    }

    static
    void set_cond_lens_phi_52(mt::Input_Multislice<T>& self, T phi_52) {
      self.cond_lens.phi_52 = phi_52 * mt::c_deg_2_rad;
    }

    static
    T get_cond_lens_c_54(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.c_54;
    }

    static
    void set_cond_lens_c_54(mt::Input_Multislice<T>& self, T c_54) {
      self.cond_lens.c_54 = c_54;
    }

    static
    T get_cond_lens_phi_54(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.phi_54 / mt::c_deg_2_rad;
    }

    static
    void set_cond_lens_phi_54(mt::Input_Multislice<T>& self, T phi_54) {
      self.cond_lens.phi_54 = phi_54 * mt::c_deg_2_rad;
    }

    static
    T get_cond_lens_c_56(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.c_56;
    }

    static
    void set_cond_lens_c_56(mt::Input_Multislice<T>& self, T c_56) {
      self.cond_lens.c_56 = c_56;
    }

    static
    T get_cond_lens_phi_56(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.phi_56 / mt::c_deg_2_rad;
    }

    static
    void set_cond_lens_phi_56(mt::Input_Multislice<T>& self, T phi_56) {
      self.cond_lens.phi_56 = phi_56 * mt::c_deg_2_rad;
    }

    static
    T get_cond_lens_inner_aper_ang(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.inner_aper_ang / mt::c_mrad_2_rad;
    }

    static
    void set_cond_lens_inner_aper_ang(mt::Input_Multislice<T>& self, T inner_aper_ang) {
      self.cond_lens.inner_aper_ang = inner_aper_ang * mt::c_mrad_2_rad;
    }

    static
    T get_cond_lens_outer_aper_ang(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.outer_aper_ang / mt::c_mrad_2_rad;
    }

    static
    void set_cond_lens_outer_aper_ang(mt::Input_Multislice<T>& self, T outer_aper_ang) {
      self.cond_lens.outer_aper_ang = outer_aper_ang * mt::c_mrad_2_rad;
    }

    static
    T get_cond_lens_ti_a(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.ti_a;
    }

    static
    void set_cond_lens_ti_a(mt::Input_Multislice<T>& self, T ti_a) {
      self.cond_lens.ti_a = ti_a;
    }

    static
    T get_cond_lens_ti_sigma(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.ti_sigma;
    }

    static
    void set_cond_lens_ti_sigma(mt::Input_Multislice<T>& self, T ti_sigma) {
      self.cond_lens.ti_sigma = ti_sigma;
    }

    static
    T get_cond_lens_ti_beta(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.ti_beta;
    }

    static
    void set_cond_lens_ti_beta(mt::Input_Multislice<T>& self, T ti_beta) {
      self.cond_lens.ti_beta = ti_beta;
    }

    static
    int get_cond_lens_ti_npts(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.ti_npts;
    }

    static
    void set_cond_lens_ti_npts(mt::Input_Multislice<T>& self, int ti_npts) {
      self.cond_lens.ti_npts = ti_npts;
    }
    
    static
    T get_cond_lens_si_a(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.si_a;
    }

    static
    void set_cond_lens_si_a(mt::Input_Multislice<T>& self, T si_a) {
      self.cond_lens.si_a = si_a;
      self.obj_lens.si_a = si_a;
    }

    static
    T get_cond_lens_si_sigma(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.si_sigma;
    }

    static
    void set_cond_lens_si_sigma(mt::Input_Multislice<T>& self, T si_sigma) {
      self.cond_lens.si_sigma = si_sigma;
      self.obj_lens.si_sigma = si_sigma;
    }

    static
    T get_cond_lens_si_beta(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.si_beta;
    }
    
    static
    void set_cond_lens_si_beta(mt::Input_Multislice<T>& self, T si_beta) {
      self.cond_lens.si_beta = si_beta;
      self.obj_lens.si_beta = si_beta;
    }
    
    static
    int get_cond_lens_si_rad_npts(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.si_rad_npts;
    }

    static
    void set_cond_lens_si_rad_npts(mt::Input_Multislice<T>& self, int si_rad_npts) {
      self.cond_lens.si_rad_npts = si_rad_npts;
      self.obj_lens.si_rad_npts = si_rad_npts;
    }
    
    static
    int get_cond_lens_si_azm_npts(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.si_azm_npts;
    }

    static
    void set_cond_lens_si_azm_npts(mt::Input_Multislice<T>& self, int si_azm_npts) {
      self.cond_lens.si_azm_npts = si_azm_npts;
      self.obj_lens.si_azm_npts = si_azm_npts;
    }

    static
    mt::eZero_Defocus_Type get_cond_lens_zero_defocus_type(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.zero_defocus_type;
    }

    static
    void set_cond_lens_zero_defocus_type(mt::Input_Multislice<T>& self, mt::eZero_Defocus_Type zero_defocus_type) {
      self.cond_lens.zero_defocus_type = zero_defocus_type;
    }

    static
    T get_cond_lens_zero_defocus_plane(const mt::Input_Multislice<T>& self) {
      return self.cond_lens.zero_defocus_plane;
    }

    static
    void set_cond_lens_zero_defocus_plane(mt::Input_Multislice<T>& self, T zero_defocus_plane) {
      self.cond_lens.zero_defocus_plane = zero_defocus_plane;
    }

    static
    int get_obj_lens_m(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.m;
    }

    static
    void set_obj_lens_m(mt::Input_Multislice<T>& self, int m) {
      self.obj_lens.m = m;
    }

    static
    T get_obj_lens_c_10(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.c_10;
    }

    static
    void set_obj_lens_c_10(mt::Input_Multislice<T>& self, T c_10) {
      self.obj_lens.c_10 = c_10;
    }

    static
    T get_obj_lens_c_12(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.c_12;
    }

    static
    void set_obj_lens_c_12(mt::Input_Multislice<T>& self, T c_12) {
      self.obj_lens.c_12 = c_12;
    }

    static
    T get_obj_lens_phi_12(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.phi_12 / mt::c_deg_2_rad;
    }

    static
    void set_obj_lens_phi_12(mt::Input_Multislice<T>& self, T phi_12) {
      self.obj_lens.phi_12 = phi_12 * mt::c_deg_2_rad;
    }

    static
    T get_obj_lens_c_21(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.c_21;
    }

    static
    void set_obj_lens_c_21(mt::Input_Multislice<T>& self, T c_21) {
      self.obj_lens.c_21 = c_21;
    }

    static
    T get_obj_lens_phi_21(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.phi_21 / mt::c_deg_2_rad;
    }

    static
    void set_obj_lens_phi_21(mt::Input_Multislice<T>& self, T phi_21) {
      self.obj_lens.phi_21 = phi_21 * mt::c_deg_2_rad;
    }

    static
    T get_obj_lens_c_23(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.c_23;
    }

    static
    void set_obj_lens_c_23(mt::Input_Multislice<T>& self, T c_23) {
      self.obj_lens.c_23 = c_23;
    }

    static
    T get_obj_lens_phi_23(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.phi_23 / mt::c_deg_2_rad;
    }

    static
    void set_obj_lens_phi_23(mt::Input_Multislice<T>& self, T phi_23) {
      self.obj_lens.phi_23 = phi_23 * mt::c_deg_2_rad;
    }

    static
    T get_obj_lens_c_30(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.c_30 / mt::c_mm_2_Angs;
    }

    static
    void set_obj_lens_c_30(mt::Input_Multislice<T>& self, T c_30) {
      self.obj_lens.c_30 = c_30 * mt::c_mm_2_Angs;
    }

    static
    T get_obj_lens_c_32(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.c_32;
    }

    static
    void set_obj_lens_c_32(mt::Input_Multislice<T>& self, T c_32) {
      self.obj_lens.c_32 = c_32;
    }

    static
    T get_obj_lens_phi_32(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.phi_32 / mt::c_deg_2_rad;
    }

    static
    void set_obj_lens_phi_32(mt::Input_Multislice<T>& self, T phi_32) {
      self.obj_lens.phi_32 = phi_32 * mt::c_deg_2_rad;
    }

    static
    T get_obj_lens_c_34(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.c_34;
    }

    static
    void set_obj_lens_c_34(mt::Input_Multislice<T>& self, T c_34) {
      self.obj_lens.c_34 = c_34;
    }

    static
    T get_obj_lens_phi_34(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.phi_34 / mt::c_deg_2_rad;
    }

    static
    void set_obj_lens_phi_34(mt::Input_Multislice<T>& self, T phi_34) {
      self.obj_lens.phi_34 = phi_34 * mt::c_deg_2_rad;
    }

    static
    T get_obj_lens_c_41(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.c_41;
    }

    static
    void set_obj_lens_c_41(mt::Input_Multislice<T>& self, T c_41) {
      self.obj_lens.c_41 = c_41;
    }

    static
    T get_obj_lens_phi_41(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.phi_41 / mt::c_deg_2_rad;
    }

    static
    void set_obj_lens_phi_41(mt::Input_Multislice<T>& self, T phi_41) {
      self.obj_lens.phi_41 = phi_41 * mt::c_deg_2_rad;
    }

    static
    T get_obj_lens_c_43(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.c_43;
    }

    static
    void set_obj_lens_c_43(mt::Input_Multislice<T>& self, T c_43) {
      self.obj_lens.c_43 = c_43;
    }

    static
    T get_obj_lens_phi_43(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.phi_43 / mt::c_deg_2_rad;
    }

    static
    void set_obj_lens_phi_43(mt::Input_Multislice<T>& self, T phi_43) {
      self.obj_lens.phi_43 = phi_43 * mt::c_deg_2_rad;
    }

    static
    T get_obj_lens_c_45(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.c_45;
    }

    static
    void set_obj_lens_c_45(mt::Input_Multislice<T>& self, T c_45) {
      self.obj_lens.c_45 = c_45;
    }

    static
    T get_obj_lens_phi_45(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.phi_45 / mt::c_deg_2_rad;
    }

    static
    void set_obj_lens_phi_45(mt::Input_Multislice<T>& self, T phi_45) {
      self.obj_lens.phi_45 = phi_45 * mt::c_deg_2_rad;
    }

    static
    T get_obj_lens_c_50(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.c_50 / mt::c_mm_2_Angs;
    }

    static
    void set_obj_lens_c_50(mt::Input_Multislice<T>& self, T c_50) {
      self.obj_lens.c_50 = c_50 * mt::c_mm_2_Angs;
    }

    static
    T get_obj_lens_c_52(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.c_52;
    }

    static
    void set_obj_lens_c_52(mt::Input_Multislice<T>& self, T c_52) {
      self.obj_lens.c_52 = c_52;
    }

    static
    T get_obj_lens_phi_52(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.phi_52 / mt::c_deg_2_rad;
    }

    static
    void set_obj_lens_phi_52(mt::Input_Multislice<T>& self, T phi_52) {
      self.obj_lens.phi_52 = phi_52 * mt::c_deg_2_rad;
    }

    static
    T get_obj_lens_c_54(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.c_54;
    }

    static
    void set_obj_lens_c_54(mt::Input_Multislice<T>& self, T c_54) {
      self.obj_lens.c_54 = c_54;
    }

    static
    T get_obj_lens_phi_54(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.phi_54 / mt::c_deg_2_rad;
    }

    static
    void set_obj_lens_phi_54(mt::Input_Multislice<T>& self, T phi_54) {
      self.obj_lens.phi_54 = phi_54 * mt::c_deg_2_rad;
    }

    static
    T get_obj_lens_c_56(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.c_56;
    }

    static
    void set_obj_lens_c_56(mt::Input_Multislice<T>& self, T c_56) {
      self.obj_lens.c_56 = c_56;
    }

    static
    T get_obj_lens_phi_56(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.phi_56 / mt::c_deg_2_rad;
    }

    static
    void set_obj_lens_phi_56(mt::Input_Multislice<T>& self, T phi_56) {
      self.obj_lens.phi_56 = phi_56 * mt::c_deg_2_rad;
    }

    static
    T get_obj_lens_inner_aper_ang(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.inner_aper_ang / mt::c_mrad_2_rad;
    }

    static
    void set_obj_lens_inner_aper_ang(mt::Input_Multislice<T>& self, T inner_aper_ang) {
      self.obj_lens.inner_aper_ang = inner_aper_ang * mt::c_mrad_2_rad;
    }

    static
    T get_obj_lens_outer_aper_ang(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.outer_aper_ang / mt::c_mrad_2_rad;
    }

    static
    void set_obj_lens_outer_aper_ang(mt::Input_Multislice<T>& self, T outer_aper_ang) {
      self.obj_lens.outer_aper_ang = outer_aper_ang * mt::c_mrad_2_rad;
    }

    static
    T get_obj_lens_ti_a(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.ti_a;
    }

    static
    void set_obj_lens_ti_a(mt::Input_Multislice<T>& self, T ti_a) {
      self.obj_lens.ti_a = ti_a;
    }

    static
    T get_obj_lens_ti_sigma(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.ti_sigma;
    }

    static
    void set_obj_lens_ti_sigma(mt::Input_Multislice<T>& self, T ti_sigma) {
      self.obj_lens.ti_sigma = ti_sigma;
    }

    static
    T get_obj_lens_ti_beta(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.ti_beta;
    }

    static
    void set_obj_lens_ti_beta(mt::Input_Multislice<T>& self, T ti_beta) {
      self.obj_lens.ti_beta = ti_beta;
    }

    static
    int get_obj_lens_ti_npts(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.ti_npts;
    }

    static
    void set_obj_lens_ti_npts(mt::Input_Multislice<T>& self, int ti_npts) {
      self.obj_lens.ti_npts = ti_npts;
    }
    
    static
    mt::eZero_Defocus_Type get_obj_lens_zero_defocus_type(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.zero_defocus_type;
    }

    static
    void set_obj_lens_zero_defocus_type(mt::Input_Multislice<T>& self, mt::eZero_Defocus_Type zero_defocus_type) {
      self.obj_lens.zero_defocus_type = zero_defocus_type;
    }

    static
    T get_obj_lens_zero_defocus_plane(const mt::Input_Multislice<T>& self) {
      return self.obj_lens.zero_defocus_plane;
    }

    static
    void set_obj_lens_zero_defocus_plane(mt::Input_Multislice<T>& self, T zero_defocus_plane) {
      self.obj_lens.zero_defocus_plane = zero_defocus_plane;
    }

    static
    mt::eScanning_Type get_scanning_type(const mt::Input_Multislice<T>& self) {
      return self.scanning.type;
    }

    static
    void set_scanning_type(mt::Input_Multislice<T>& self, mt::eScanning_Type scanning_type) {
      self.scanning.type = scanning_type;
    }

    static
    bool get_scanning_periodic(const mt::Input_Multislice<T>& self) {
      return self.scanning.pbc;
    }

    static
    void set_scanning_periodic(mt::Input_Multislice<T>& self, bool scanning_periodic) {
      self.scanning.pbc = scanning_periodic;
    }

    static
    bool get_scanning_square(const mt::Input_Multislice<T>& self) {
      return self.scanning.spxs;
    }

    static
    void set_scanning_square(mt::Input_Multislice<T>& self, bool scanning_square) {
      self.scanning.spxs = scanning_square;
    }

    static
    int get_scanning_ns(const mt::Input_Multislice<T>& self) {
      return self.scanning.ns;
    }

    static
    void set_scanning_ns(mt::Input_Multislice<T>& self, int scanning_ns) {
      self.scanning.ns = scanning_ns;
    }

    static
    T get_scanning_x0(const mt::Input_Multislice<T>& self) {
      return self.scanning.x0;
    }

    static
    void set_scanning_x0(mt::Input_Multislice<T>& self, T scanning_x0) {
      self.scanning.x0 = scanning_x0;
    }

    static
    T get_scanning_y0(const mt::Input_Multislice<T>& self) {
      return self.scanning.y0;
    }

    static
    void set_scanning_y0(mt::Input_Multislice<T>& self, T scanning_y0) {
      self.scanning.y0 = scanning_y0;
    }

    static
    T get_scanning_xe(const mt::Input_Multislice<T>& self) {
      return self.scanning.xe;
    }

    static
    void set_scanning_xe(mt::Input_Multislice<T>& self, T scanning_xe) {
      self.scanning.xe = scanning_xe;
    }

    static
    T get_scanning_ye(const mt::Input_Multislice<T>& self) {
      return self.scanning.ye;
    }

    static
    void set_scanning_ye(mt::Input_Multislice<T>& self, T scanning_ye) {
      self.scanning.ye = scanning_ye;
    }

    static
    int get_ped_nrot(const mt::Input_Multislice<T>& self) {
      return self.nrot;
    }

    // FIXME Could simplify and remove
    static
    void set_ped_nrot(mt::Input_Multislice<T>& self, int ped_nrot) {
      self.nrot = ped_nrot;
    }

    // FIXME Could simplify and remove
    static
    T get_ped_theta(const mt::Input_Multislice<T>& self) {
      return self.theta / mt::c_deg_2_rad;
    }

    // FIXME Could simplify and remove
    static
    void set_ped_theta(mt::Input_Multislice<T>& self, T ped_theta) {
      self.theta = ped_theta * mt::c_deg_2_rad;
    }

    // FIXME Could simplify and remove
    static
    int get_hci_nrot(const mt::Input_Multislice<T>& self) {
      return self.nrot;
    }

    // FIXME Could simplify and remove
    static
    void set_hci_nrot(mt::Input_Multislice<T>& self, int hci_nrot) {
      self.nrot = hci_nrot;
    }

    // FIXME Could simplify and remove
    static
    T get_hci_theta(const mt::Input_Multislice<T>& self) {
      return self.theta / mt::c_deg_2_rad;
    }

    // FIXME Could simplify and remove
    static
    void set_hci_theta(mt::Input_Multislice<T>& self, T hci_theta) {
      self.theta = hci_theta * mt::c_deg_2_rad;
    }

    static
    int get_eels_Z(const mt::Input_Multislice<T>& self) {
      return self.eels_fr.Z;
    }

    static
    void set_eels_Z(mt::Input_Multislice<T>& self, int eels_Z) {
      self.eels_fr.Z = eels_Z;
    }

    static
    T get_eels_E_loss(const mt::Input_Multislice<T>& self) {
      return self.eels_fr.E_loss / mt::c_eV_2_keV;
    }

    static
    void set_eels_E_loss(mt::Input_Multislice<T>& self, T eels_E_loss) {
      self.eels_fr.E_loss = eels_E_loss * mt::c_eV_2_keV;
    }

    static
    T get_eels_collection_angle(const mt::Input_Multislice<T>& self) {
      return self.eels_fr.collection_angle / mt::c_mrad_2_rad;
    }

    static
    void set_eels_collection_angle(mt::Input_Multislice<T>& self, T eels_collection_angle) {
      self.eels_fr.collection_angle = eels_collection_angle * mt::c_mrad_2_rad;
    }

    static
    int get_eels_m_selection(const mt::Input_Multislice<T>& self) {
      return self.eels_fr.m_selection;
    }

    static
    void set_eels_m_selection(mt::Input_Multislice<T>& self, int eels_m_selection) {
      self.eels_fr.m_selection = eels_m_selection;
    }

    static
    mt::eChannelling_Type get_eels_channelling_type(const mt::Input_Multislice<T>& self) {
      return self.eels_fr.channelling_type;
    }

    static
    void set_eels_channelling_type(mt::Input_Multislice<T>& self, mt::eChannelling_Type eels_channelling_type) {
      self.eels_fr.channelling_type = eels_channelling_type;
    }

    static
    int get_eftem_Z(const mt::Input_Multislice<T>& self) {
      return self.eels_fr.Z;
    }

    static
    void set_eftem_Z(mt::Input_Multislice<T>& self, int eftem_Z) {
      self.eels_fr.Z = eftem_Z;
    }

    static
    T get_eftem_E_loss(const mt::Input_Multislice<T>& self) {
      return self.eels_fr.E_loss / mt::c_eV_2_keV;
    }

    static
    void set_eftem_E_loss(mt::Input_Multislice<T>& self, T eftem_E_loss) {
      self.eels_fr.E_loss = eftem_E_loss * mt::c_eV_2_keV;
    }

    static
    T get_eftem_collection_angle(const mt::Input_Multislice<T>& self) {
      return self.eels_fr.collection_angle / mt::c_mrad_2_rad;
    }

    static
    void set_eftem_collection_angle(mt::Input_Multislice<T>& self, T eftem_collection_angle) {
      self.eels_fr.collection_angle = eftem_collection_angle * mt::c_mrad_2_rad;
    }

    static
    int get_eftem_m_selection(const mt::Input_Multislice<T>& self) {
      return self.eels_fr.m_selection;
    }

    static
    void set_eftem_m_selection(mt::Input_Multislice<T>& self, int eftem_m_selection) {
      self.eels_fr.m_selection = eftem_m_selection;
    }

    static
    mt::eChannelling_Type get_eftem_channelling_type(const mt::Input_Multislice<T>& self) {
      return self.eels_fr.channelling_type;
    }

    static
    void set_eftem_channelling_type(mt::Input_Multislice<T>& self, mt::eChannelling_Type eftem_channelling_type) {
      self.eels_fr.channelling_type = eftem_channelling_type;
    }

    static
    int get_output_area_ix_0(const mt::Input_Multislice<T>& self) {
      return self.output_area.ix_0 + 1;
    }

    static
    void set_output_area_ix_0(mt::Input_Multislice<T>& self, int ix_0) {
      self.output_area.ix_0 = ix_0 - 1;
    }

    static
    int get_output_area_iy_0(const mt::Input_Multislice<T>& self) {
      return self.output_area.iy_0 + 1;
    }

    static
    void set_output_area_iy_0(mt::Input_Multislice<T>& self, int iy_0) {
      self.output_area.iy_0 = iy_0 - 1;
    }

    static
    int get_output_area_ix_e(const mt::Input_Multislice<T>& self) {
      return self.output_area.ix_e + 1;
    }

    static
    void set_output_area_ix_e(mt::Input_Multislice<T>& self, int ix_e) {
      self.output_area.ix_e = ix_e - 1;
    }

    static
    int get_output_area_iy_e(const mt::Input_Multislice<T>& self) {
      return self.output_area.iy_e + 1;
    }

    static
    void set_output_area_iy_e(mt::Input_Multislice<T>& self, int iy_e) {
