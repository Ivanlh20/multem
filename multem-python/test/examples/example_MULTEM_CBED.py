...
def run():
    ...
    input_multem.simulation_type = "CBED"
    ...
    input_multem.illumination_model = 4
    ...
    input_multem.cond_lens_ti_beta = 0.0
    ...
    input_multem.cond_lens_si_beta = 0.0
    input_multem.cond_lens_si_rad_npts = 4
    input_multem.cond_lens_si_azm_npts = 4

    input_multem.cond_lens_zero_defocus_type = "User_Define"
