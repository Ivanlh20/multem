...
def run():
    ...
    input_multem.cond_lens_phi_12 = (
        0.0
    )  # Azimuthal angle of the twofold astigmatism (�)
    input_multem.cond_lens_c_23 = 0.0  # Threefold astigmatism (�)
    input_multem.cond_lens_phi_23 = (
        0.0
    )  # Azimuthal angle of the threefold astigmatism (�)
    ...
    input_multem.cond_lens_si_sigma = (
        0.2
    )  # standard deviation: For parallel ilumination(�^-1) otherwise (�)
    ...
    # ax = numpy.arange(0, input_multem.spec_lx)/numpy.arange(input_multem.nx, input_multem.spec_lx)
    # ay = numpy.arange(0, input_multem.spec_ly)/numpy.arange(input_multem.ny, input_multem.spec_ly)
