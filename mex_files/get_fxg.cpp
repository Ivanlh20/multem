...
void mexFunction(int nlhs,mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	auto g = mx_get_matrix<m_matrix_r>(prhs[2]);

	auto fxg = mx_create_matrix<m_matrix_r>(g.rows, g.cols, plhs[0]);
	auto dfxg = mx_create_matrix<m_matrix_r>(g.rows, g.cols, plhs[1]);
