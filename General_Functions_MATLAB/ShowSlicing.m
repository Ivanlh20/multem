function []=ShowSlicing(TEM, inFP, nf)
[Atoms, Slice] = getSliceSpecimen(TEM.Atoms, TEM.lx, TEM.ly, TEM.dz, inFP, TEM.DimFP, TEM.SeedFP);
S = getAtomTypes(TEM.PotPar);
...
Planes = getPlanes(TEM.Atoms, TEM.lx, TEM.ly, inFP, TEM.DimFP, TEM.SeedFP);
[nPlanes, ~] = size(Planes);
for i = 1:nPlanes
    hold on;
