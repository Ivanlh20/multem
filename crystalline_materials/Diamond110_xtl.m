function [atoms, lx, ly, lz, a, b, c, dz] = Diamond110_xtl(na, nb, nc, ncu, rmsd_3d)
    ...
    xtl_parm.base = [6, 0.00, 0.00, 0.00, rmsd_3d, occ, region, charge;...
                        6, 0.50, 0.75, 0.00, rmsd_3d, occ, region, charge;...
                        6, 0.00, 0.25, 0.50, rmsd_3d, occ, region, charge;...
                        6, 0.50, 0.50, 0.50, rmsd_3d, occ, region, charge];
