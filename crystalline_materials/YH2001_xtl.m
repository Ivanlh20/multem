function [atoms, lx, ly, lz, a, b, c, dz] = YH2001_xtl(na, nb, nc, ncu, rms3d_Y, rms3d_H)
    xtl_parm.na = na;
    xtl_parm.nb = nb;
    xtl_parm.nc = nc;
    a = 5.2000; 
    ...
    xtl_parm.uLayer(1).atoms = [39, 0.0, 0.0, 0.0, rms3d_Y, occ, region, charge; 39, 0.5, 0.5, 0.0, rms3d_Y, occ, region, charge];
    xtl_parm.uLayer(2).atoms = [1, 0.25, 0.25, 0.25, rms3d_H, occ, region, charge; 1, 0.75, 0.25, 0.25, rms3d_H, occ, region, charge; 1, 0.25, 0.75, 0.25, rms3d_H, occ, region, charge; 1, 0.75, 0.75, 0.25, rms3d_H, occ, region, charge];
