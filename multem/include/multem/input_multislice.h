...
namespace mt
{
    ...
    std::vector<T> thick; 								// Array of thickes
    ...
    std::vector<complex<T>> iw_psi; 					// user define incident wave
    std::vector<T> iw_x;								// x position
    std::vector<T> iw_y; 								// y position
    ...
    std::vector<T> cdl_var; 							// Array of thickes

    std::vector<int> iscan;
    std::vector<T> beam_x;								// temporal variables
    std::vector<T> beam_y;
		...
		/**************************************************************************************/
    // FIXME These functions result in a compiler error
		//T Rx_exp_factor()
		//{
