...
namespace mt
{
	...
	template <class SU>
	CGPU_EXEC
	SU iGrid_sxd<ST, edim_3>::size_cast() const 
	{ 
		return SU(size());
	}
	...
	template <class SU>
	CGPU_EXEC
	SU iGrid_sxd<ST, edim_3>::isize_cast() const
	{ 
...
#ifdef __CUDACC__
	template <class ST>
 	dim3 iGrid_sxd<ST, edim_3>::d_blk_size()
	{
		return fcn_cdb_size();
	}
			
	template <class ST>
 	dim3 iGrid_sxd<ST, edim_3>::d_grid_size(const dim3 d_grid_max)
	{
	...
	template <class ST>
 	D_Grid_Blk iGrid_sxd<ST, edim_3>::d_grid_blk_size(const dim3 d_grid_max)
	{
