...
void f_scVp_cudaFree(int &ncVp, scVp *&cVp){
	for(int icVp=0; icVp<ncVp; icVp++){
		...
		f_sciVn_cudaFree(cVp[icVp].ciV0);
		f_sciVn_cudaFree(cVp[icVp].ciV1);
...
void f_scVp_cudaInit(int ncVp, scVp *&cVp){
	for(int icVp=0; icVp<ncVp; icVp++){
		...
		f_sCoefPar_Init(cVp[icVp].cVr);
		f_sciVn_cudaInit(cVp[icVp].ciV0);
		f_sciVn_cudaInit(cVp[icVp].ciV1);
...
void f_scVp_cudaMalloc(int ncVp, scVp *&cVp){
	...
	for(int icVp=0; icVp<ncVp; icVp++){
		...
		f_sCoefPar_Init(cVp[icVp].cVr);
		f_sciVn_cudaMalloc(stnR, cVp[icVp].ciV0);
		f_sciVn_cudaMalloc(stnR, cVp[icVp].ciV1);
