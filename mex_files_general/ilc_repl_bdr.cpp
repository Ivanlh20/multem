...
void mex_run(dt_int32 nlhs, mxArray* plhs[], dt_int32 nrhs, const mxArray* prhs[])
{
	...
	auto bg_opt = (nrhs>2)?mex_get_enum<mt::eFil_Sel_Typ>(prhs[2]):mt::efst_min;
	auto bg = (nrhs>3)?mex_get_num<T>(prhs[3]):T(0);

	/***************************************************************************************/
	mt::iBorder_Rect_2d iborder(bdr_i);
	auto mx_o = mt::fcn_repl_bdr(pmx_i, iborder, bg_opt, bg);
