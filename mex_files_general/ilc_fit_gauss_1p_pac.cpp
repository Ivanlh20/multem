...
void mexFunction(dt_int32 nlhs, mxArray* plhs[], dt_int32 nrhs, const mxArray* prhs[]) 
{
	...
	/***************************************************************************************/
	mt::Fit_Gauss_1P_PAC<dt_float64, edev_cpu> Fit_Gauss_1P_PAC;
	Fit_Gauss_1P_PAC.init_variables(Rx, Ry, pos, lambda_0);
	auto ee_norm = Fit_Gauss_1P_PAC.fit(Ixy, cstr, coef);
