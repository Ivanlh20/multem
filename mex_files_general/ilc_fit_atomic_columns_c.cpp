...
#include "eval_fit_atomic_columns_c.hpp"
...
void mexFunction(dt_int32 nlhs, mxArray* plhs[], dt_int32 nrhs, const mxArray* prhs[]) 
{
	...
	auto rcstr_i = mex_get_pvctr<pMLD>(prhs[5]);
	...
	/***************************************************************************************/
	mt::Fit_Atomic_Columns_C<dt_float64, edev_cpu> fit_atomic_columns;
	auto norm = fit_atomic_columns.fit(Ixy, Rx, Ry, pos, cstr, coef);
