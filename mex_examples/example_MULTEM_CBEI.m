...
input_multislice.obj_lens_f = 0;                  % Defocus (Å)
input_multislice.obj_lens_Cs3 = 0.00;                % Third order spherical aberration (mm)
...
input_multislice.obj_lens_beta = 0;               % Divergence semi-angle (mrad)
...
input_multislice.thickness = 0:4*c:1000;          % Array of thicknesses
