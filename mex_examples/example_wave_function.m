...
input_multislice.ewfs_x0 = 0.5*input_multislice.lx;                % x position 
input_multislice.ewfs_y0 = 0.5*input_multislice.lx;                % y position
%%%%%%%%%%%%%%%%%%%%%%%%%% EW Real Space %%%%%%%%%%%%%%%%%%%%%%%%
input_multislice.ewrs_convergent_beam = 1;     % 1: true, 0:false
input_multislice.ewrs_x0 = 4               % x position 
input_multislice.ewrs_y0 = 4;               % y position
