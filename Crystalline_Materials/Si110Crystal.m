...
CrysPar.uLayer(1).atoms = [14, charge, 0.00, 0.00, 0.00, rms3d, 1; 14, charge, 0.50, 0.75, 0.00, rms3d, 1];
CrysPar.uLayer(2).atoms = [14, charge, 0.00, 0.25, 0.50, rms3d, 1; 14, charge, 0.50, 0.50, 0.50, rms3d, 1];
