...
CrysPar.uLayer(1).atoms = [14, 0.00, 0.00, 0.00, rms3d, 1, charge; 14, 0.50, 0.75, 0.00, rms3d, 1, charge];
CrysPar.uLayer(2).atoms = [14, 0.00, 0.25, 0.50, rms3d, 1, charge; 14, 0.50, 0.50, 0.50, rms3d, 1, charge];
