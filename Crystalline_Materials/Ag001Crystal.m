...
CrysPar.uLayer(1).atoms = [47, 0.0, 0.0, 0.0, rms3d, 1, charge; 47, 0.5, 0.5, 0.0, rms3d, 1, charge];
CrysPar.uLayer(2).atoms = [47, 0.0, 0.5, 0.5, rms3d, 1, charge; 47, 0.5, 0.0, 0.5, rms3d, 1, charge];
