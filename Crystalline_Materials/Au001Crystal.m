...
CrysPar.uLayer(1).atoms = [79, 0.0, 0.0, 0.0, rms3d, 1, charge; 79, 0.5, 0.5, 0.0, rms3d, 1, charge];
CrysPar.uLayer(2).atoms = [79, 0.0, 0.5, 0.5, rms3d, 1, charge; 79, 0.5, 0.0, 0.5, rms3d, 1, charge];
