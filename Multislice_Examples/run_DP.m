...
TEM.gpu = 0;                % Gpu card
TEM.SimType = 31;           % 11: STEM, 12: ISTEM, 21: CBED, 22: CBEI, 31: ED, 32: HRTEM, 41: PED, 42: HCI, ... 51: EW Fourier, 52: EW real
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
na = 10; nb = 10; nc = 20; ncu = 8; sigma = 0.076;  nxyuc = 512;
[TEM.Atoms, TEM.lx, TEM.ly, lz, a, b, c, TEM.dz] = Si001Crystal(na, nb, nc, ncu, sigma);
Atoms = TEM.Atoms;
% save('Si001_10x10x20.txt','Atoms','-ascii')
