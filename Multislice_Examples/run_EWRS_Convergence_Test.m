...
TEM.nConfFP = 2;            % Number of frozen phonon configurations
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
na = 8; nb = 8; nc = 2; ncu = 8; rmsAu3D = 0.085; sigma = sqrt(rmsAu3D^2/3);
...
axis image;
M2aPsi = abs(aPsi).^2;
aM2Psi = AverageMatrix(aM2Psi, na, nb, true);
M2aPsi = AverageMatrix(M2aPsi, na, nb, true);
